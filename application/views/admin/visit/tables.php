								...
								<div class="panel-body">
									...
									<table class="table">
										...
										<tbody>
											...
											<tr>
												<td><?=$value['time'];?></td>
												<td><i class="ion ion-eye"></i> <?=$value['count'];?> 次 </td>
												<td><i class="ion ion-android-person"></i> <?=$value['ipcount'];?> 人 </td>
												<td><a href="<?=$this->adm_url.'visit/day_visit_li/'.$value['time']?>">
													<button class="btn btn-primary waves-effect" type="button">查看详细记录</button>
													</a>
												</td>
											</tr>
											<?endforeach;?>
