							...
							<div class="panel panel-lined panel-hovered mb20 table-responsive basic-table">
								...
								<div class="panel-body">
									...
									<table class="table">
										...
										<tbody>
											<?php foreach($article_li as $key=>$value){?>
											<tr>
												<td>
												...
												<td><?=$value['pv'];?></td>
												<td>
													<label class="label label-<?=$value['color'];?> mr5"><?=$value['type_name'];?></label>
												</td>
												<td>
													<button class="btn btn-primary waves-effect" type="button">查看</button>
													<a href="<?=site_url().'admin/article/edit_article/'.$value['id'];?>">
														<button class="btn btn-success waves-effect" type="button">编辑</button>
													</a>
													<a href="<?=site_url().'admin/article/del_article/'.$value['id'];?>">
														<button class="btn btn-danger waves-effect" type="button">删除</button>
													</a>
												</td>
											</tr>
											<?php }?>
