							...
							<div class="col-sm-12 col-md-12">
								<div class="panel panel-default panel-hovered panel-stacked mb30">
									...
									<div class="panel-body">
											...
											<!-- with hint -->
											<div class="form-group">
												<label class="col-md-2 control-label">阅读量</label>
												<div class="col-md-4">
													<input type="text" name="PV" class="form-control" placeholder="" value="0">
											...
											<!-- native select -->
											<div class="form-group">
												<label class="col-md-2 control-label">发布类目</label>
												<div class="col-md-4">
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<textarea rows="5" name="intro" class="form-control resize-v" placeholder="填写简介 不超过80字！"></textarea>
												</div>
											</div>
